...
@NgModule({
  declarations: [
    //Bu modülün hangi nesnelerden oluştuğunu burada bildiriyoruz. Bir component bir modüle deklare edilebilir.
    AppComponent,
  ...
  imports: [
    //Component bir modülde deklare edilebildiği için başka yerde kullanma ihtiyacı olduğunda; buraya yaılır. Modül başka modüllerde import edilebilir ve bu şekilde kullanılabilir.
    BrowserModule, //Bir modül başka bir modülü tüketecekse import edilir.
    AppRoutingModule,
    HttpClientModule,
    SharedModule,
    FormsModule, //Template driven çalışabilmek için bu import edilmeli.
